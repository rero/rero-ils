...
- Adapt backend for the new UI version (PrimeNG/Angular19) [\#3805](https://github.com/rero/rero-ils/pull/3805) (by @Garfield-fr & @jma)

**Enhancements:**

- Entities: Enhance autocomplete [\#3854](https://github.com/rero/rero-ils/issues/3854) (by @jma)
- Acquisitions: add ability to clear `parent_account` field [\#2875](https://github.com/rero/rero-ils/issues/2875) (by @jma)
- Acquisition accounts: allow extend/collapse of hierarchy [\#3771](https://github.com/rero/rero-ils/issues/3771) (by @jma)
- Circulation UI alerts auto-dismiss [\#3758](https://github.com/rero/rero-ils/issues/3758) (by @Garfield-fr)
- Add a new frontpage user message fonctionality [\#3697](https://github.com/rero/rero-ils/issues/3697) (by @rerowep)
- Add a `raw` subfield for call_numbers in document index [\#3833](https://github.com/rero/rero-ils/issues/3833) (by @PascalRepond)
- Disable the javascript requirement for login view [\#3826](https://github.com/rero/rero-ils/issues/3826) (by @jma)
- Public interface: always show search bar in the header [\#3811](https://github.com/rero/rero-ils/issues/3811) (by @rerowep)
- chore(jsonschemas): enhance main descriptions and remove useless $schemas descriptions [\#3840](https://github.com/rero/rero-ils/pull/3840) (by @PascalRepond)
- messages: Add message cli [\#3810](https://github.com/rero/rero-ils/pull/3810) (by @rerowep)
- files: change template and max_files_count [\#3808](https://github.com/rero/rero-ils/pull/3808) (by @rerowep)
- acquisition: add logging file to rollover cli [\#3801](https://github.com/rero/rero-ils/pull/3801) (by @rerowep)

**Fixes:**

- api harvester: fix timestamp [\#3862](https://github.com/rero/rero-ils/pull/3862) (by @rerowep)
- fix(csv serializers): enhance excel compatibility [\#3863](https://github.com/rero/rero-ils/issues/3863) (by @PascalRepond)
- fix(intended_audience): correct content of the dropdown [\#3869](https://github.com/rero/rero-ils/issues/3869) (by @PascalRepond)
- fix(babeltheque): prevent "more info" to display before the ng app [\#3871](https://github.com/rero/rero-ils/issues/3871) (by @PascalRepond)
- fix(acq_orders): order date facet content [\#3860](https://github.com/rero/rero-ils/issues/3860) (by @PascalRepond)
- fix(editor): autocomplete fields scrollheight [\#3861](https://github.com/rero/rero-ils/issues/3861) (by @PascalRepond)
- fix: null document pid in the patron transaction events index [\#3852](https://github.com/rero/rero-ils/issues/3852) (by @jma)
- Acquisitions: adding a receipt line right after order leads to an error 403 [\#3414](https://github.com/rero/rero-ils/issues/3414) (by @jma)
- late issues view: error 403 in console [\#3307](https://github.com/rero/rero-ils/issues/3307) (by @Garfield-fr)
- The shortcuts using a combination with shift are not working with QWERTY or QWERTZ keyboards. [\#1445](https://github.com/rero/rero-ils/issues/1445) (by @jma)
- The shortcuts using a combination with shift are not working with QWERTY or QWERTZ keyboards. [\#1445](https://github.com/rero/rero-ils/issues/1445) (by @jma)
- Local entities : genre/form field [\#3825](https://github.com/rero/rero-ils/issues/3825) (by @Garfield-fr)
- Acquisitions: wrong indentation when changing parent account to other level [\#2874](https://github.com/rero/rero-ils/issues/2874) (by @jma)
- Acquisitions: parent account dropdown should exclude current account and its children (error 500) [\#2873](https://github.com/rero/rero-ils/issues/2873) (by @jma)
- JSONschema editors: form `addons` are not translated [\#3547](https://github.com/rero/rero-ils/issues/3547) (by @PascalRepond)
- mappings: document_type in item is not updated on document change [\#3140](https://github.com/rero/rero-ils/issues/3140) (by @rerowep)
- URL size limited by uwsgi in certain deployments [\#3806](https://github.com/rero/rero-ils/issues/3806) (by @rerowep)
- Ebooks that do not exist in the provider are not correctly deleted/updated in ILS [\#3718](https://github.com/rero/rero-ils/issues/3718) (by @rerowep)
- Operation logs: anonymize notification recipient [\#3807](https://github.com/rero/rero-ils/issues/3807) (by @PascalRepond)
- Missing permissions on certain API endpoints [\#3740](https://github.com/rero/rero-ils/issues/3740) (by @rerowep)
- fix(entities): wrong date in public view [\#3843](https://github.com/rero/rero-ils/pull/3843) (by @PascalRepond)
- remote entities: fix sync [\#3823](https://github.com/rero/rero-ils/pull/3823) (by @rerowep)
- fix(stats): make active patrons period 12 months [\#3819](https://github.com/rero/rero-ils/pull/3819) (by @PascalRepond)
- fix(tests): fix test problems [\#3820](https://github.com/rero/rero-ils/pull/3820) (by @PascalRepond)
- monitoring: better timestamps [\#3799](https://github.com/rero/rero-ils/pull/3799) (by @rerowep)

**Other changes:**

- chore(tests): add exceptions [\#3864](https://github.com/rero/rero-ils/pull/3864) (by @PascalRepond)
- feat(permissions): change update receipts permissions [\#3870](https://github.com/rero/rero-ils/pull/3870) (by @jma)
- chore(permissions): add details for acquisition permissions [\#3872](https://github.com/rero/rero-ils/pull/3872) (by @jma)
- chore(user): update config for the datepicker [\#3874](https://github.com/rero/rero-ils/pull/3874) (by @Garfiled-fr)
- migration: create the database migration alembic file [\#3858](https://github.com/rero/rero-ils/pull/3858) (by @rerowep)
- migration: fixes and better code [\#3832](https://github.com/rero/rero-ils/pull/3832) (by @rerowep)
- fix(translations): use poetry commands [\#3844](https://github.com/rero/rero-ils/pull/3844) (by @PascalRepond)
- chore: update dependencies [\#3824](https://github.com/rero/rero-ils/pull/3824) (by @rerowep)
- cached: fix cached functions [\#3817](https://github.com/rero/rero-ils/pull/3817) (by @rerowep)
- chore: update dependencies [\#3815](https://github.com/rero/rero-ils/pull/3815) (by @rerowep)
- chore(fixtures): add missing serial acq settings [\#3803](https://github.com/rero/rero-ils/pull/3803) (by @PascalRepond)
- chore: delete Twitter link in test frontpage [\#3800](https://github.com/rero/rero-ils/pull/3800) (by @PascalRepond)
...
- contributions: better update_contributions [\#2728](https://github.com/rero/rero-ils/pull/2728) ([rerowep](https://github.com/rerowep))
...
- holding: better delete_standard_holdings_having_no_items [\#2724](https://github.com/rero/rero-ils/pull/2724) ([rerowep](https://github.com/rerowep))
...
- issues: fix 'received_date' required conditions. [\#2721](https://github.com/rero/rero-ils/pull/2721) ([zannkukai](https://github.com/zannkukai))
...
- document: fix invenio_celery.tasks endpoints. [\#2696](https://github.com/rero/rero-ils/pull/2696) ([rerowep](https://github.com/rerowep))
...
- patron_types: add a limit for unpaid subscription [\#2644](https://github.com/rero/rero-ils/pull/2644) [[f: circulation](https://github.com/rero/rero-ils/labels/f:%20circulation)] [[f: search](https://github.com/rero/rero-ils/labels/f:%20search)] [[f: user management](https://github.com/rero/rero-ils/labels/f:%20user%20management)] [[f: data migration](https://github.com/rero/rero-ils/labels/f:%20data%20migration)] ([zannkukai](https://github.com/zannkukai))
...
- modules: fix get_all_pids [\#2614](https://github.com/rero/rero-ils/pull/2614) ([rerowep](https://github.com/rerowep))
...
- notifications: fix email_notification_type [\#2568](https://github.com/rero/rero-ils/pull/2568) ([rerowep](https://github.com/rerowep))
...
- Make field "second_call_number" visible in requests interface [\#2398](https://github.com/rero/rero-ils/issues/2398)
...
- loans: fix loan_anonymizer [\#2433](https://github.com/rero/rero-ils/pull/2433) ([rerowep](https://github.com/rerowep))
...
- items: add second call_number on dump [\#2442](https://github.com/rero/rero-ils/pull/2442) ([zannkukai](https://github.com/zannkukai))
...
- circulation: fix loan end_date [\#2435](https://github.com/rero/rero-ils/pull/2435) ([zannkukai](https://github.com/zannkukai))
...
- Generate square brackets in genre_form field [\#2237](https://github.com/rero/rero-ils/issues/2237)
...
- notifications: use the library name for pickup_name [\#2333](https://github.com/rero/rero-ils/pull/2333) ([jma](https://github.com/jma))
...
- operation_log: replace pid by value for operation_log indexing [\#2138](https://github.com/rero/rero-ils/pull/2138) ([BadrAly](https://github.com/BadrAly))
...
- cli: fix create_or_update when pid is reserved [\#2163](https://github.com/rero/rero-ils/pull/2163) ([BadrAly](https://github.com/BadrAly))
...
- Github actions test stops with an error related to test_document_boosting [\#1603](https://github.com/rero/rero-ils/issues/1603)
...
- serials: fix issue.status_date field update [\#1911](https://github.com/rero/rero-ils/pull/1911) ([zannkukai](https://github.com/zannkukai))
...
- cli: fix wait_empty_tasks [\#1938](https://github.com/rero/rero-ils/pull/1938) ([rerowep](https://github.com/rerowep))
...
- items: add new temporary_location field [\#2002](https://github.com/rero/rero-ils/pull/2002) ([BadrAly](https://github.com/BadrAly))
...
- data: set local_fields field minLength to 1 char [\#1972](https://github.com/rero/rero-ils/pull/1972) ([BadrAly](https://github.com/BadrAly))
...
- add icon_docmaintype_children.svg [\#1831](https://github.com/rero/rero-ils/pull/1831) ([rerowep](https://github.com/rerowep))
...
- users: set local_code field minLength to 1 [\#1880](https://github.com/rero/rero-ils/pull/1880) ([BadrAly](https://github.com/BadrAly))
...
- CHECKOUT_4 or CHECKOUT_5 does not work as expected. [\#1379](https://github.com/rero/rero-ils/issues/1379)
...
- holdings: fix is_serial definition [\#1648](https://github.com/rero/rero-ils/pull/1648) ([BadrAly](https://github.com/BadrAly))
...
- items: use temporary item_type for circulation [\#1609](https://github.com/rero/rero-ils/pull/1609) ([zannkukai](https://github.com/zannkukai))
...
- items: inherit holdings first call_number [\#1538](https://github.com/rero/rero-ils/pull/1538) ([BadrAly](https://github.com/BadrAly))
...
- Unused RERO_ILS environment variables [\#546](https://github.com/rero/rero-ils/issues/546)
...
- circulation: fix transaction end_date. [\#1532](https://github.com/rero/rero-ils/pull/1532) ([zannkukai](https://github.com/zannkukai))
...
- Holdings Editor: extra titles for the location and circulation_category fields [\#1452](https://github.com/rero/rero-ils/issues/1452)
...
- Item CHECKIN_1_1_2 does not work [\#1334](https://github.com/rero/rero-ils/issues/1334)
...
- patron_type: implements checkouts restrictions [\#1324](https://github.com/rero/rero-ils/pull/1324) ([zannkukai](https://github.com/zannkukai))
...
- ill_request: fix form validation problem [\#1315](https://github.com/rero/rero-ils/pull/1315) ([zannkukai](https://github.com/zannkukai))
...
- A due_soon notification should not have "Not renewable" [\#1342](https://github.com/rero/rero-ils/issues/1342)
...
- elasticsearch document_type deprecated [\#83](https://github.com/rero/rero-ils/issues/83)
...
- ill_request: merge US to dev [\#1251](https://github.com/rero/rero-ils/pull/1251) ([zannkukai](https://github.com/zannkukai))
...
- celery scheduler can not locate the method task_clear_and_renew_subscriptions [\#1158](https://github.com/rero/rero-ils/issues/1158)
...
- circulation: allow requests on ITEM_IN_TRANSIT_TO_HOUSE loans. [\#1169](https://github.com/rero/rero-ils/pull/1169) ([BadrAly](https://github.com/BadrAly))
...
- The property numbering_script is either in the wrong file, or to be deleted [\#1147](https://github.com/rero/rero-ils/issues/1147)
...
- check_license: accept Triple Slash Directive [\#1098](https://github.com/rero/rero-ils/pull/1098) ([blankoworld](https://github.com/blankoworld))
...
- docs: add the missing references to the add_request circulation action. [\#1023](https://github.com/rero/rero-ils/pull/1023) ([BadrAly](https://github.com/BadrAly))
...
- Documentation resources: circulation actions, reroils_resources and loan state chart [\#1017](https://github.com/rero/rero-ils/pull/1017) ([blankoworld](https://github.com/blankoworld))
...
- Errors when running run_tests.sh [\#1000](https://github.com/rero/rero-ils/issues/1000)
...
- Translate '/rero_ils/translations/messages.pot' in 'it' [\#912](https://github.com/rero/rero-ils/pull/912) ([transifex-integration[bot]](https://github.com/apps/transifex-integration))
...
- Bootstrap: attempt to install TGZ_FILE even if no option in command line [\#856](https://github.com/rero/rero-ils/issues/856)
...
- Translate '/rero_ils/translations/messages.pot' in 'nl' [\#904](https://github.com/rero/rero-ils/pull/904) ([transifex-integration[bot]](https://github.com/apps/transifex-integration))
- Translate '/rero_ils/translations/messages.pot' in 'es' [\#900](https://github.com/rero/rero-ils/pull/900) ([transifex-integration[bot]](https://github.com/apps/transifex-integration))
- Translate '/rero_ils/translations/messages.pot' in 'it' [\#897](https://github.com/rero/rero-ils/pull/897) ([transifex-integration[bot]](https://github.com/apps/transifex-integration))
- git: integrate US1232 into dev [\#896](https://github.com/rero/rero-ils/pull/896) ([reropag](https://github.com/reropag))
- Translate '/rero_ils/translations/messages.pot' in 'ar' [\#892](https://github.com/rero/rero-ils/pull/892) ([transifex-integration[bot]](https://github.com/apps/transifex-integration))
...
- location: adapt JSON schema for pickup_name required if is_pickup [\#842](https://github.com/rero/rero-ils/pull/842) ([zannkukai](https://github.com/zannkukai))
...
- patron_transaction : Adapt PatronTransaction resource [\#736](https://github.com/rero/rero-ils/pull/736) ([zannkukai](https://github.com/zannkukai))
...
- Translate '/rero_ils/translations/messages.pot' in 'en' [\#908](https://github.com/rero/rero-ils/pull/908) ([transifex-integration[bot]](https://github.com/apps/transifex-integration))
...
- Translate '/rero_ils/translations/messages.pot' in 'nl' [\#814](https://github.com/rero/rero-ils/pull/814) ([transifex-integration[bot]](https://github.com/apps/transifex-integration))
...
- Indexing : Deleting 'mef_persons' cause 'index_not_found' exception [\#601](https://github.com/rero/rero-ils/issues/601)
...
- Translate '/rero_ils/translations/messages.pot' in 'es' [\#796](https://github.com/rero/rero-ils/pull/796) ([transifex-integration[bot]](https://github.com/apps/transifex-integration))
- Translate '/rero_ils/translations/messages.pot' in 'ar' [\#785](https://github.com/rero/rero-ils/pull/785) ([transifex-integration[bot]](https://github.com/apps/transifex-integration))
...
- Translate '/rero_ils/translations/messages.pot' in 'de' [\#763](https://github.com/rero/rero-ils/pull/763) ([transifex-integration[bot]](https://github.com/apps/transifex-integration))
- translation: fix error with translation file [\#762](https://github.com/rero/rero-ils/pull/762) ([BadrAly](https://github.com/BadrAly))
- Translate '/rero_ils/translations/messages.pot' in 'es' [\#759](https://github.com/rero/rero-ils/pull/759) ([transifex-integration[bot]](https://github.com/apps/transifex-integration))
- Translate '/rero_ils/translations/messages.pot' in 'en' [\#758](https://github.com/rero/rero-ils/pull/758) ([transifex-integration[bot]](https://github.com/apps/transifex-integration))
- Translate '/rero_ils/translations/messages.pot' in 'fr' [\#757](https://github.com/rero/rero-ils/pull/757) ([transifex-integration[bot]](https://github.com/apps/transifex-integration))
...
- Translate '/rero_ils/translations/messages.pot' in 'es' [\#750](https://github.com/rero/rero-ils/pull/750) ([transifex-integration[bot]](https://github.com/apps/transifex-integration))
- Translate '/rero_ils/translations/messages.pot' in 'en' [\#748](https://github.com/rero/rero-ils/pull/748) ([transifex-integration[bot]](https://github.com/apps/transifex-integration))
...
- acq_account: disable account deletion when it has orders linked to it. [\#737](https://github.com/rero/rero-ils/pull/737) ([BadrAly](https://github.com/BadrAly))
...
- patron_transaction: create new resource json and mapping. [\#716](https://github.com/rero/rero-ils/pull/716) ([BadrAly](https://github.com/BadrAly))
...
- Not possible to add or edit a location if field is_online is not checked [\#562](https://github.com/rero/rero-ils/issues/562)
...
- Wrong availability for item_type "no checkout" [\#209](https://github.com/rero/rero-ils/issues/209)
...
- circ_policies ui: increase API size limit [\#509](https://github.com/rero/rero-ils/pull/509) ([zannkukai](https://github.com/zannkukai))
...
- circulation_ui: add error logs for item API [\#479](https://github.com/rero/rero-ils/pull/479) ([zannkukai](https://github.com/zannkukai))
...
- data_model: implement copyright date transformation [\#470](https://github.com/rero/rero-ils/pull/470) ([reropag](https://github.com/reropag))
...
- gnd_pid / pid [\#352](https://github.com/rero/rero-ils/issues/352)
...
- circulation: renewal due date from current_date [\#265](https://github.com/rero/rero-ils/pull/265) ([BadrAly](https://github.com/BadrAly))
...
- Request menu don't display the pickup_name field [\#170](https://github.com/rero/rero-ils/issues/170)
...
- Search by patron_full_name does not check the role "patrons" [\#29](https://github.com/rero/rero-ils/issues/29)
...
- RECORDS: can_delete fix for item and patron types [\#239](https://github.com/rero/rero-ils/pull/239) ([BadrAly](https://github.com/BadrAly))
...
- RECORDS: can_delete [\#195](https://github.com/rero/rero-ils/pull/195) ([BadrAly](https://github.com/BadrAly))
...
- Libraries: add options opening_hours + new library editor [\#147](https://github.com/rero/rero-ils/pull/147) ([Garfield-fr](https://github.com/Garfield-fr))
...
- missing format_date_filter in items/view [\#104](https://github.com/rero/rero-ils/pull/104) ([rerowep](https://github.com/rerowep))
...
- Executing "docker-compose run web ./populate.sh" reveals $VIRTUAL_ENV not set [\#7](https://github.com/rero/rero-ils/issues/7)

...
setup(
    cmdclass={"egg_info": EggInfoWithCompile},
    name="rero-ils",
    version=version,
    description=__doc__,
    ...
    entry_points={
        ...
        "babel.extractors": ["json = rero_ils.modules.babel_extractors:extract_json"],
        "invenio_admin.views": [
        ...
        "invenio_assets.webpack": ["reroils_theme = rero_ils.theme.webpack:theme"],
        "dojson.cli": [
            "reverse = rero_ils.dojson.cli:reverse",
            "head = rero_ils.dojson.cli:head",
        ],
        "dojson.cli.dump": ["pjson = rero_ils.dojson.cli:pretty_json_dump"],
        "dojson.cli.rule": [
        ...
        "flask.commands": [
            ...
            "messages = rero_ils.modules.monitoring.cli:messages",
        ...
        "flask.commands": [
            "api_harvester = rero_ils.modules.api_harvester.cli:api_harvester",
            "remote_entity = rero_ils.modules.entities.remote_entities.cli:remote_entity",
            "migration = rero_ils.modules.migration.cli:migration",
            "monitoring = rero_ils.modules.monitoring.cli:monitoring",
            "notifications = rero_ils.modules.notifications.cli:notifications",

...
def test_patron_transaction_events_serializers(
    client, rero_json_header, librarian_saxon, patron_transaction_overdue_event_saxon
):
...
def test_acq_orders_serializers(
    ...
    url = url_for("invenio_records_rest.acol_list", q=f"acq_order.pid:{order.pid}")

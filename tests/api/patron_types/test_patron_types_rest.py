...
def test_patron_types_permissions(client, patron_type_children_martigny, json_header):
    ...
    res, _ = postdata(client, "invenio_records_rest.ptty_list", {})
    assert res.status_code == 401
...
def test_patron_type_secure_api(
    client,
    json_header,
    patron_type_children_martigny,
    librarian_martigny,
...
def test_patron_type_secure_api_create(
    client,
    json_header,
    patron_type_children_martigny,
    ...
    res, _ = postdata(client, post_entrypoint, patron_type_children_martigny_data)
    assert res.status_code == 201
...
def test_patron_type_secure_api_update(
    client,
    json_header,
    patron_type_adults_martigny,
    system_librarian_martigny,
...
def test_patron_type_secure_api_delete(
    client,
    json_header,
    patron_type_adults_martigny,
    system_librarian_martigny,

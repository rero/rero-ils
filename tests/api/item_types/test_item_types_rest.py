...
def test_item_types_permissions(client, item_type_standard_martigny, json_header):
    ...
    res, _ = postdata(client, "invenio_records_rest.itty_list", {})
    assert res.status_code == 401
...
def test_item_type_secure_api_create(
    client,
    json_header,
    item_type_standard_martigny,
    ...
    res, _ = postdata(client, post_entrypoint, item_type_standard_martigny_data)
    assert res.status_code == 201
...
def test_item_type_secure_api_update(
    client,
    item_type_on_site_martigny,
    system_librarian_martigny,
    system_librarian_sion,
...
def test_item_type_secure_api_delete(
    client,
    item_type_on_site_martigny,
    system_librarian_martigny,
    system_librarian_sion,

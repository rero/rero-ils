...
def doc_title_travailleurs(app):
    ...
    data = {
        ...
        "seriesStatement": [{"seriesTitle": [{"value": "Boy & Girl"}]}],
    }
    doc = Document.create(data=data, delete_pid=False, dbcommit=True, reindex=True)
...
def doc_title_travailleuses(app):
    ...
    data = {
        ...
        "title": [
            {
                "type": "bf:Title",
                "mainTitle": [{"value": "Les travailleuses partent à l'école 100"}],

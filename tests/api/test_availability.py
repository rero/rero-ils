...
def test_item_can_request(
    ...
    #   --> the request is allowed
    new_item["location"]["$ref"] = get_ref_for_pid(Location, loc_public_martigny.pid)
    ...
    # remove created data
    client.delete(url_for("invenio_records_rest.item_item", pid_value=new_item.pid))
    client.delete(
        url_for("invenio_records_rest.hold_item", pid_value=new_item.holding_pid)
    )
    client.delete(url_for("invenio_records_rest.loc_item", pid_value=new_location.pid))

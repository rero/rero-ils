...
from rero_ils.modules.acq_receipts.permissions import \
    AcqReceiptPermissionPolicy


def test_receipts_permissions(
    patron_martigny, librarian_martigny, librarian2_martigny,
    system_librarian_martigny, org_martigny, vendor2_martigny,
    acq_receipt_fiction_sion, acq_receipt_fiction_saxon,
    ...
    with mock.patch(
        'rero_ils.modules.acq_receipts.api.AcqReceipt.is_active',
        False
    ):
        check_permission(AcqReceiptPermissionPolicy, {
            'search': True,

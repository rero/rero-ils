...
def test_patron_checkouts_order(
    client,
    librarian_martigny,
    patron_martigny,
    loc_public_martigny,
...
def test_item_stats(app, client, librarian_martigny, item_lib_martigny):
    """Test item stats."""
    ...
    with mock.patch.object(
        ...
        assert res.json == {"total": {"checkin": 2}, "total_year": {"checkin": 1}}

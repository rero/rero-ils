...
def test_acquisition_invoice_total_amount(client, acq_invoice_fiction_martigny):
...
def test_acquisition_invoices_post_put_delete(
    client, org_martigny, vendor2_martigny, acq_invoice_fiction_saxon, json_header
):
    """Test record retrieval."""
    # Create record / POST
    ...
    res, data = postdata(
        client, "invenio_records_rest.acin_list", acq_invoice_fiction_saxon
    )

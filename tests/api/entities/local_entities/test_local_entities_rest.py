...
def test_local_entities_permissions(client, roles, local_entity_person, json_header):
    """Test record retrieval."""
    item_url = url_for("invenio_records_rest.locent_item", pid_value="locent_pers")
...
def test_local_entities_post_put_delete(client, local_entity_person_data, json_header):
    ...
    res, data = postdata(client, "invenio_records_rest.locent_list", local_entity_data)
...
def test_local_search_by_proxy(client, local_entity_genre_form, local_entity_org):

...
def csv_header():
    """Load json headers."""
    return [("Accept", "text/csv"), ("Content-Type", "application/json")]
...
def rero_marcxml_header():
    ...
    return [("Accept", "application/json"), ("Content-Type", "application/marcxml+xml")]


@pytest.fixture(scope="session")
def rero_json_header():
    """Load json headers."""
    return [("Accept", "application/rero+json"), ("Content-Type", "application/json")]


@pytest.fixture(scope="session")
def export_json_header():
    """Load json headers."""
    return [("Accept", "application/export+json"), ("Content-Type", "application/json")]
...
def mef_agents_url(app):
    ...
    return app.config.get("RERO_ILS_MEF_CONFIG", {}).get("agents", {}).get("base_url")
...
def bnf_ean_any_9782070541270():
    ...
    file_name = join(dirname(__file__), "data/xml/bnf/bnf_ean_any_9782070541270.xml")
    with open(file_name, "rb") as file:
        return file.read()
...
def bnf_ean_any_9782072862014():
    ...
    file_name = join(dirname(__file__), "data/xml/bnf/bnf_ean_any_9782072862014.xml")
    with open(file_name, "rb") as file:
        return file.read()
...
def bnf_anywhere_all_peter():
    ...
    file_name = join(dirname(__file__), "data/xml/bnf/bnf_anywhere_all_peter.xml")
    with open(file_name, "rb") as file:
        return file.read()
...
def loc_isbn_all_9781604689808():
    ...
    file_name = join(dirname(__file__), "data/xml/loc/loc_isbn_all_9781604689808.xml")
    with open(file_name, "rb") as file:
        return file.read()
...
def loc_isbn_all_9780821417478():
    ...
    file_name = join(dirname(__file__), "data/xml/loc/loc_isbn_all_9780821417478.xml")
    with open(file_name, "rb") as file:
        return file.read()
...
def loc_anywhere_all_samuelson():
    ...
    file_name = join(dirname(__file__), "data/xml/loc/loc_anywhere_all_samuelson.xml")
    with open(file_name, "rb") as file:
        return file.read()
...
def loc_recordid_all_2014043016():
    ...
    file_name = join(dirname(__file__), "data/xml/loc/loc_recordid_all_2014043016.xml")
    with open(file_name, "rb") as file:
        return file.read()
...
def dnb_isbn_9783862729852():
    ...
    file_name = join(dirname(__file__), "data/xml/dnb/dnb_isbn_9783862729852.xml")
    with open(file_name, "rb") as file:
        return file.read()
...
def dnb_recordid_1214325203():
    ...
    file_name = join(dirname(__file__), "data/xml/dnb/dnb_recordid_1214325203.xml")
    with open(file_name, "rb") as file:
        return file.read()
...
def slsp_isbn_9782296076648():
    ...
    file_name = join(dirname(__file__), "data/xml/slsp/slsp_isbn_9782296076648.xml")
    with open(file_name, "rb") as file:
        return file.read()
...
def slsp_isbn_3908497272():
    ...
    file_name = join(dirname(__file__), "data/xml/slsp/slsp_isbn_3908497272.xml")
    with open(file_name, "rb") as file:
        return file.read()
...
def slsp_recordid_9910137():
    ...
    file_name = join(dirname(__file__), "data/xml/slsp/slsp_recordid_9910137.xml")
    with open(file_name, "rb") as file:
        return file.read()
...
def ugent_anywhere_123():
    ...
    file_name = join(dirname(__file__), "data/xml/ugent/ugent_anywhere_123.xml")
    with open(file_name, "rb") as file:
        return file.read()
...
def ugent_isbn_9781108422925():
    ...
    file_name = join(dirname(__file__), "data/xml/ugent/ugent_isbn_9781108422925.xml")
    with open(file_name, "rb") as file:
        return file.read()
...
def ugent_isbn_9780415773867():
    ...
    file_name = join(dirname(__file__), "data/xml/ugent/ugent_isbn_9780415773867.xml")
    with open(file_name, "rb") as file:
        return file.read()
...
def ugent_samuelson():
    ...
    file_name = join(dirname(__file__), "data/xml/ugent/ugent_samuelson.xml")
    with open(file_name, "rb") as file:
        return file.read()
...
def ugent_recordid_001247835():
    ...
    file_name = join(dirname(__file__), "data/xml/ugent/ugent_recordid_001247835.xml")
    with open(file_name, "rb") as file:
        return file.read()
...
def ugent_book_without_26X():
    ...
    file_name = join(dirname(__file__), "data/xml/ugent/ugent_book_without_26X.xml")
    with open(file_name, "rb") as file:
        return file.read()
...
def kul_isbn_9782265089419():
    ...
    file_name = join(dirname(__file__), "data/xml/kul/kul_isbn_9782265089419.xml")
    with open(file_name, "rb") as file:
        return file.read()
...
def kul_recordid_9992876296301471():
    ...
    file_name = join(dirname(__file__), "data/xml/kul/kul_recordid_99928762.xml")
    with open(file_name, "rb") as file:
        return file.read()
...
def kul_book_without_26X():
    ...
    file_name = join(dirname(__file__), "data/xml/kul/kul_book_without_26X.xml")
    with open(file_name, "rb") as file:
        return file.read()

...
from rero_ils.modules.documents.fetchers import document_id_fetcher as fetcher
from rero_ils.modules.documents.minters import document_id_minter as minter

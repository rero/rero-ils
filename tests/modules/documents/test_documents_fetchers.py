...
from reroils_app.modules.documents.fetchers import \
    document_id_fetcher as fetcher
from reroils_app.modules.documents.minters import document_id_minter as minter

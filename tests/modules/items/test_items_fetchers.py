...
from reroils_app.modules.items.fetchers import item_id_fetcher as fetcher
from reroils_app.modules.items.minters import item_id_minter as minter


def test_item_id_fetcher(db):
    """Test item_id fetcher."""
    data = {}
    rec_uuid = uuid4()

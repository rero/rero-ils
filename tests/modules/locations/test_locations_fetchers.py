...
from rero_ils.modules.locations.fetchers import location_id_fetcher as fetcher
from rero_ils.modules.locations.minters import location_id_minter as minter

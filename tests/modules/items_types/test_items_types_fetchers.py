...
from rero_ils.modules.items_types.fetchers import \
    item_type_id_fetcher as fetcher
from rero_ils.modules.items_types.minters import item_type_id_minter as minter


def test_item_type_id_fetcher(db):

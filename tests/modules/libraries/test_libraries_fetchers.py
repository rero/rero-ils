...
from rero_ils.modules.libraries.fetchers import library_id_fetcher as fetcher
from rero_ils.modules.libraries.minters import library_id_minter as minter


def test_library_id_fetcher(db):
    """Test library_id fetcher."""
    data = {}
    rec_uuid = uuid4()

...
from rero_ils.modules.mef.fetchers import mef_person_id_fetcher as fetcher
from rero_ils.modules.mef.minters import mef_person_id_minter as minter


def test_mef_id_fetcher(db):
    """Test mef_person_id fetcher."""
    data = {'pid': '5'}
    rec_uuid = uuid4()

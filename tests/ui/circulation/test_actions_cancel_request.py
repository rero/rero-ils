...
def test_cancel_item_request_in_transit_for_pickup_with_requests_same_lib(
    client,
    item3_in_transit_martigny_patron_and_loan_for_pickup,
    loc_public_martigny,
    librarian_martigny,
    librarian_fully,
    loc_public_fully,
...
def test_cancel_request_on_item_at_desk_no_requests_at_home(
    client,
    item2_at_desk_martigny_patron_and_loan_at_desk,
    loc_public_martigny,
    librarian_martigny,
):
...
def test_cancel_request_on_item_at_desk_with_requests_externally(
    client,
    item3_at_desk_martigny_patron_and_loan_at_desk,
    loc_public_martigny,
    librarian_martigny,
    patron2_martigny,
    loc_public_fully,
...
def test_cancel_request_on_item_at_desk_with_requests_at_home(
    client,
    item4_at_desk_martigny_patron_and_loan_at_desk,
    loc_public_martigny,
    librarian_martigny,
    patron2_martigny,
):
...
def test_cancel_pending_request_on_item_at_desk(
    client,
    item5_at_desk_martigny_patron_and_loan_at_desk,
    loc_public_martigny,
    librarian_martigny,
    patron2_martigny,
):

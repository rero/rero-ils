...
def test_holding_item_links(
    ...
    assert item.holding_circulation_category_pid == item_type_standard_martigny.pid
    ...
    assert Holding.get_document_pid_by_holding_pid(item2.holding_pid) == document.pid

...
def test_stats_report_number_of_patrons(
    ...
    cfg = {
        ...
        "is_active": True,
        "category": {"indicator": {"type": "number_of_patrons"}},
    }
    ...
    assert StatsReport(cfg).collect() == [["", "2023-11"], ["female", 1], ["male", 1]]
    ...
    assert StatsReport(cfg).collect() == [["", "female", "male"], ["2023", 1, 1]]
        ...
        body={
            ...
            "loan": {
                ...
                "patron": {
                    ...
                    "hashed_pid": hashlib.md5(patron_martigny.pid.encode()).hexdigest(),
                },
                "item": {"library_pid": lib_martigny.pid},

...
def test_acq_accounts_es_mapping(
    search, db, acq_account_fiction_martigny_data, budget_2020_martigny, lib_martigny
):
    ...
    account = AcqAccount.create(
        acq_account_fiction_martigny_data, dbcommit=True, reindex=True, delete_pid=True
    )

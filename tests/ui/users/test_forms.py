...
@mock.patch(
    "flask_security.views.reset_password_token_status",
    mock.MagicMock(return_value=[False, False, {"email": "foo@foo.com"}]),
)
@mock.patch("flask_security.views.update_password", mock.MagicMock())

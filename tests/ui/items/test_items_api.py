...
def test_get_links_to_me_with_fees(patron_transaction_overdue_saxon):
    ...
    assert item.get_links_to_me(get_pids=True) == {"fees": ["1"], "loans": ["1"]}

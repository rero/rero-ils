...
from rero_ils.modules.files.cli import create_pdf_record_files, load_files_for_document
...
def person2_response_data(person2_data):
    ...
    return {"hits": {"hits": [{"id": person2_data["pid"], "metadata": person2_data}]}}
...
def holding_lib_saxon_w_patterns(
    app,
    journal,
    holding_lib_saxon_w_patterns_data,
    loc_public_saxon,
    item_type_standard_martigny,
    vendor_martigny,
):

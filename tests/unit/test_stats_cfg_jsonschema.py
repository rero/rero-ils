...
def test_valid_circulation_n_docs(stats_cfg_schema):
    ...
    data = {
        "$schema": "https://bib.rero.ch/schemas/stats_cfg/stat_cfg-v0.0.1.json",
        "pid": "statcfg1",
        "name": "foo",
        "description": "bar",
        "frequency": "month",
...
def test_valid_circulation_n_serial_holdings(stats_cfg_schema):
    ...
    data = {
        ...
        "category": {
            "type": "catalog",
            "indicator": {"type": "number_of_serial_holdings"},
        },
        "is_active": True,
    }
...
def test_valid_circulation_n_items(stats_cfg_schema):
    ...
    data = {
        ...
        "frequency": "month",
        "library": {"$ref": "https://bib.rero.ch/api/libraries/lib1"},
        "category": {"type": "catalog", "indicator": {"type": "number_of_items"}},
        "is_active": True,
    }
    for dist in [
        "created_month",
...
def test_valid_circulation_n_patrons(stats_cfg_schema):
    ...
    data = {
        ...
        "category": {
            ...
            "indicator": {"type": "number_of_patrons"},
        },
        "is_active": True,
    }
    for dist in [
...
def test_valid_circulation_n_active_patrons(stats_cfg_schema):
    ...
    data = {
        ...
        "category": {
            "type": "user_management",
            "indicator": {"type": "number_of_active_patrons"},
        },
        "is_active": True,
    }
...
def test_valid_circulation_n_deleted_items(stats_cfg_schema):
    ...
    data = {
        ...
        "category": {
            "type": "catalog",
            "indicator": {"type": "number_of_deleted_items"},
        },
        "is_active": True,
    }
    for period in ["year", "month"]:
...
def test_valid_circulation_n_ill_requests(stats_cfg_schema):
    ...
    data = {
        ...
        "category": {
            "type": "circulation",
            "indicator": {"type": "number_of_ill_requests"},
        },
        "is_active": True,
    }
    for dist in ["created_month", "created_year", "pickup_location", "status"]:
        data["category"]["indicator"]["distributions"] = [dist]
        validate(data, stats_cfg_schema)
...
def test_valid_circulation_n_circulations(stats_cfg_schema):
    ...
    data = {
        ...
        "frequency": "month",
        "library": {"$ref": "https://bib.rero.ch/api/libraries/lib1"},
        "category": {"type": "circulation", "indicator": {}},
        "is_active": True,
    }
    for trigger in ["checkin"]:

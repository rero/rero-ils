        ...
        "provisionActivity": [
            {
                ...
                "statement": [
                    ...
                    {"label": [{"value": "Ed. Cornélius"}], "type": "bf:Agent"},
                    {"label": [{"value": "2007-2020"}], "type": "Date"},
                ],
                "type": "bf:Publication",
            }
        ],
...
def test_identified_by_to_marc21(app, marc21_record):
    ...
    record = {
        "identifiedBy": [
            {"type": "bf:Isbn", "value": "9782824606835"},
            {
                "type": "bf:Isbn",
                "value": "12345678901??",
                "status": "status",
...
def test_title_to_marc21(app, marc21_record):
    ...
    record = {
        "title": [
            {
                ...
                "subtitle": [{"value": "exercices corrigés avec rappels de cours"}],
                "part": [
                    {
        ...
        "responsibilityStatement": [[{"value": "Edmond Berrebi"}]],
    }
    date, record = add_created_updated(record)
    result = to_marc21.do(record)
    record = deepcopy(marc21_record)
    ...
    record = {
        "title": [
            {"mainTitle": [{"value": "Suisse"}], "type": "bf:Title"},
            {"mainTitle": [{"value": "Schweiz"}], "type": "bf:ParallelTitle"},
            {
...
def test_provision_activity_copyright_date_to_marc21(app, marc21_record):
    ...
    record = {
        ...
        "provisionActivity": [
            {
                "place": [{"canton": "vd", "country": "sz", "type": "bf:Place"}],
                "startDate": 1980,
                "statement": [
                    {"label": [{"value": "Lausanne"}], "type": "bf:Place"},
                    {
                        "label": [{"value": "Institut Benjamin Constant"}],
                        "type": "bf:Agent",
                    },
                    {"label": [{"value": "Genève"}], "type": "bf:Place"},
                    {"label": [{"value": "Slatkine"}], "type": "bf:Agent"},
                    {"label": [{"value": "Paris"}], "type": "bf:Place"},
                    {
                        "label": [{"value": "diff. France : H. Champion"}],
                        "type": "bf:Agent",
                    },
                    {"label": [{"value": "1980-"}], "type": "Date"},
                ],
                "type": "bf:Publication",
            }
        ],
    ...
    record = {
        "provisionActivity": [
            {
                "endDate": 1975,
                "place": [{"canton": "ne", "country": "sz", "type": "bf:Place"}],
                "startDate": 1907,
                "statement": [
                    {"label": [{"value": "La Chaux-de-Fonds"}], "type": "bf:Place"},
                    {
                        "label": [{"value": "Union Chrétienne de Jeunes Gens"}],
                        "type": "bf:Agent",
                    },
                    {"label": [{"value": "1907-1975"}], "type": "Date"},
                ],
                "type": "bf:Publication",
            },
            {
...
def test_physical_description_to_marc21(app, marc21_record):
    ...
    record = {
        "extent": "159 p.",
        "note": [{"label": "fig.", "noteType": "otherPhysicalDetails"}],
        "dimensions": ["33 cm"],
    }
    date, record = add_created_updated(record)
    result = to_marc21.do(record)
...
def test_subjects_to_marc21(
    ...
    record = {
        "subjects": [
            ...
            {
                "entity": {
                    "$ref": f"{mef_concepts_url}/api/concepts/idref/ent_concept_idref",
                    "pid": "ent_concept",
                }
            },
            {
            ...
            {
                "entity": {
                    "authorized_access_point": "Bases de donn\u00e9esi (Voltenauer, Marc)",
                    "type": "bf:Work",
                    "identifiedBy": {
                        "type": "RERO",
                        "value": "A001234567",
            ...
            },
            {
                "entity": {
                    ...
                    "identifiedBy": {"type": "IdRef", "value": "027249654"},
                    "source": "rero",
                    "type": "bf:Place",
                }
            },
            {
                "entity": {
                    ...
                    "type": "bf:Temporal",
                    "identifiedBy": {"type": "RERO", "value": "A026984216"},
                }
            },
        ]
    }
...
def test_genre_form_to_marc21(app, mef_concepts_url, marc21_record, mef_concept1):
...
def test_contribution_to_marc21(
    app,
    mef_agents_url,
    marc21_record,
    ...
    record.update(
        {
            ...
            "710__": (
                {"__order__": ("a", "4"), "a": "Université de Genève", "4": "ctb"},
                {
                    "__order__": ("a", "4", "0", "0"),
                    "a": "Université de Genève",
                    "4": "aut",
...
def test_type_to_marc21(app, marc21_record):
    ...
    record = {
        "type": [
            {"main_type": "docmaintype_comic", "subtype": "docsubtype_manga"},
            {"main_type": "docmaintype_map", "subtype": "docsubtype_atlas"},
        ]
    }
    date, record = add_created_updated(record)
    result = to_marc21.do(record)
...
def test_holdings_items_to_marc21(
    ...
    marc21 = deepcopy(marc21_record)
    marc21.update({"__order__": ("leader", "001", "005", "008"), "001": document.pid})
    assert result == marc21
    ...
    marc21.update(
        {
            ...
            "949__": {
                ...
                "E": "https://bm.ebibliomedia.ch/resources/5f780fc22357943b9a83ca3d",
            },
        }
    )
    assert result == marc21

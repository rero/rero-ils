...
class TextSerializer(object):
    ...
    def format_record(self, record):
        ...
        bib_fields.append(';'.join([v.get('name') for v in record.get('authors', [])]))
        ...
        for citem in record.get('citems', []):
            ...
            item_fields.append(str(citem.get('_circulation', {}).get('status')))
...
text_v1 = TextSerializer()
text_v1_response = record_responsify(text_v1, 'text/csv')
text_v1_search = search_responsify(text_v1, 'text/csv')

...
@Component({
  ...
  <section class="card-text">
    <section class="collapse" id="{{'library'+record.metadata.pid }}">
      <dl class="row mb-0">
        <dt class="col-md-2" translate>Address:</dt>
        <dd class="col-md-10 mb-0" translate>{{ record.metadata.address }}</dd>
        <dt class="col-md-2" translate>Email:</dt>
      ...
      <section class="row">
        <ul class="col-lg-6 list-group list-group-flush mb-2">
          <li *ngFor="let opening_hour of record.metadata.opening_hours" class="list-group-item py-0 pr-0 border-0">
            ...
            <div *ngIf="!opening_hour.is_open" class="row">
              <span class="col-6 col-md-3">{{ opening_hour.day }}:</span><span class="col-3"> Closed</span>
            </div>
          </li>
        </ul>
    ...
    <div id="collapseBasic" [collapse]="isCollapsed">
      ...
      <div *ngIf="!locations.length">no location</div>
    </div>
  </section>
  `,
  styles: []

...
RECORDS_REST_ENDPOINTS = dict(
    ...
    doc=dict(
        ...
        item_route=(
            "/documents/<pid(doc, record_class="
    ...
    itty=dict(
        ...
        item_route=(
            "/item_types/<pid(itty, record_class="
    ...
    stacfg=dict(
        ...
        item_route=(
            "/stats_cfg/<pid(stacfg, record_class="
    ...
    pttr=dict(
        ...
        item_route=(
            '/patron_transactions/<pid(pttr, record_class="'
    ...
    ptre=dict(
        ...
        item_route=(
            "/patron_transaction_events/<pid(ptre, record_class="
    ...
    ptty=dict(
        ...
        item_route=(
            "/patron_types/<pid(ptty, record_class="
    ...
    cipo=dict(
        ...
        item_route=(
            "/circ_policies/<pid(cipo, record_class="
    ...
    notif=dict(
        ...
        item_route=(
            "/notifications/<pid(notif, record_class="
    ...
    acac=dict(
        ...
        item_route=(
            "/acq_accounts/<pid(acac, record_class="
    ...
    acor=dict(
        ...
        item_route=(
            "/acq_orders/<pid(acor, record_class="
    ...
    acol=dict(
        ...
        item_route=(
            "/acq_order_lines/<pid(acol, record_class="
    ...
    acre=dict(
        ...
        item_route=(
            "/acq_receipts/<pid(acre, record_class="
    ...
    acrl=dict(
        ...
        item_route=(
            "/acq_receipt_lines/<pid(acrl, record_class="
    ...
    acin=dict(
        ...
        item_route=(
            "/acq_invoices/<pid(acin, record_class="
...
RECORDS_REST_SORT_OPTIONS["items"]["call_number"] = dict(
    fields=["call_number.raw"], title="Call Number", default_order="asc"
)
RECORDS_REST_SORT_OPTIONS["items"]["second_call_number"] = dict(
    fields=["second_call_number.raw"], title="Second call Number", default_order="asc"
)

        ...
        i18n_aggs=dict(
            ...
            subject_fiction=dict(
                en=dict(
                    ...
                    filter=dict(bool=dict(must=[dict(
                        terms=dict(facet_genre_form_en=FICTIONS_TERMS))])
                    )
                ),
                fr=dict(
                    terms=dict(
                    ...
                    filter=dict(bool=dict(must=[dict(
                        terms=dict(facet_genre_form_fr=FICTIONS_TERMS))])
                    )
                ),
                de=dict(
                    terms=dict(
                    ...
                    filter=dict(bool=dict(must=[dict(
                        terms=dict(facet_genre_form_de=FICTIONS_TERMS))])
                    )
                ),
                it=dict(
                    terms=dict(
                    ...
                    filter=dict(bool=dict(must=[dict(
                        terms=dict(facet_genre_form_it=FICTIONS_TERMS))]))
                    ),
            ),
            subject_no_fiction=dict(
                en=dict(
                    ...
                    filter=dict(bool=dict(must_not=[dict(
                        terms=dict(facet_genre_form_en=FICTIONS_TERMS))])
                    )
                ),
                fr=dict(

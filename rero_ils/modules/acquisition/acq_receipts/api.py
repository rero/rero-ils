...
class AcqReceipt(AcquisitionIlsRecord):
    ...
    def get_links_to_me(self, get_pids=False):
        ...
        acq_receipt_lines = sorted_pids(receipt_lines_query) if get_pids else receipt_lines_query.count()
    ...
    def get_receipt_lines(self, output=None):
        ...
        """
        query = AcqReceiptLinesSearch().filter("term", acq_receipt__pid=self.pid)

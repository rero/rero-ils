...
class AcqAccount(IlsRecord):
    ...
    def get_related_order_lines(self, count=False):
        ...
        return query.count() if count else _list_object()
    ...
    def get_children(self, count=False):
        """Get children accounts related to this account.

        :param count: if true, return the number of children.
    ...
    def get_related_invoices(self, count=False):
        """Get invoices related to this account.

        :param count: if true, return the number of related invoices.
    ...
    def get_links_to_me(self):
        ...
        links = {
            'acq_order_lines': self.get_related_order_lines(count=True),
            'acq_accounts': self.get_children(count=True),
            'acq_invoices': self.get_related_invoices(count=True)
        }

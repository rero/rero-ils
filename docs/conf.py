...
g = {}
with open(
    os.path.join(os.path.dirname(__file__), "..", "rero_ils", "version.py")
) as fp:
    exec(fp.read(), g)
...
latex_documents = [
    (master_doc, "rero-ils.tex", "rero-ils Documentation", "RERO", "manual"),
]
...
man_pages = [(master_doc, "rero-ils", "rero-ils Documentation", [author], 1)]
